...
from get_f5_token import get_token
from f5api_token_call import f5api_get_call
...
def main():
    ...
    ltm_stats = f5api_get_call(ipaddr, token, uri_ext)
    os.system('cls')
    ...
    my_ltm_virt = f5api_get_call(ipaddr, token, uri_ext)
    os.system('cls')
